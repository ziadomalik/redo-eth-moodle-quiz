<div style="text-align: center;">
  <img src="./media/problem-description.png" alt="Problem Description, Art by @fallenchungus" style="max-width: 100%; height: auto;">
</div>
...
![Download Repository](./media/download-repository.png)
